...
public class Dash_AimBot {
    ...
    public static Scalar BLUE_MIN_THRESH = new Scalar(75, 213, 92);
    public static Scalar RED_MAX_THRESH = new Scalar(113, 202, 125);
    public static Scalar RED_MIN_THRESH = new Scalar(13, 172, 95);
