...
public class Dash_AimBot {
    ...
    // Thresholding values
    public static Scalar BLUE_MAX_THRESH = new Scalar(134, 255, 149);
    public static Scalar BLUE_MIN_THRESH = new Scalar(74, 199, 89);
    public static Scalar RED_MAX_THRESH = new Scalar(115, 199, 126);
    public static Scalar RED_MIN_THRESH = new Scalar(15, 169, 96);
